...
import { splitMessages, sendMessagesWithDelay } from './util/index'; // Corrigido o caminho de importação
            ...
            (async () => {
              ...
              for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
                try {
                  ...
                  console.log(`Resposta da AI recebida para chatId ${chatId}: ${answer}`);
                  break;
                } catch (error) {
